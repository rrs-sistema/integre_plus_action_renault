...
class AppPages {
	...
	static final pages = [
		...
		GetPage(name: Routes.colaboradoresListPage, page:()=> const ColaboradoresListPage(), binding: ColaboradoresBindings()), 
		GetPage(name: Routes.colaboradoresTabPage, page:()=> ColaboradoresTabPage()),
		GetPage(name: Routes.supervisoresListPage, page:()=> const SupervisoresListPage(), binding: SupervisoresBindings()), 
