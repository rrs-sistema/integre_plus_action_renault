...
import 'package:integre_plus_action_renault/app/page/trilha/menu_interno_botao.dart';
...
class MenuInternoBotoes extends StatelessWidget {
  ...
  const MenuInternoBotoes(
      {Key? key, this.primeiroBotao, this.segundoBotao, this.terceiroBotao, this.quartoBotao})
      : super(key: key);
  @override
