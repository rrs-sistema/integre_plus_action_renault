...
(function dartProgram() {
  ...
  A.DelegatedDatabase_ensureOpen_closure.prototype = {
    call$0() {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, e, s, error, stackTrace, replacement, _0_0, t2, t3, exception, t1, $async$exception;
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$currentError = $async$result;
          $async$goto = $async$handler;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = $async$self.$this;
              if (t1._closed) {
                error = new A.StateError("Can't re-open a database after closing it. Please create a new database connection and open that instead.");
                A.checkNotNullable(error, "error", type$.Object);
                t1 = $.Zone__current;
                stackTrace = null;
                if (t1 !== B.C__RootZone) {
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootHandleUncaughtError$closure", 5, null, ["call$5"], ["_rootHandleUncaughtError"], 63, 0);
    ...
    _static(A, "async___rootRunBinary$closure", 6, null, ["call$3$6"], ["_rootRunBinary"], 66, 0);
    ...
    _static(A, "async___rootErrorCallback$closure", 5, null, ["call$5"], ["_rootErrorCallback"], 70, 0);
    ...
    _static_1(A, "async___printToZone$closure", "_printToZone", 75);
    _static(A, "async___rootFork$closure", 5, null, ["call$5"], ["_rootFork"], 76, 0);
    _instance(A._AsyncCompleter.prototype, "get$complete", 1, 0, null, ["call$1", "call$0"], ["complete$1", "complete$0"], 51, 0, 0);
    ...
    _instance(A.MessagePort.prototype, "get$postMessage", 1, 1, null, ["call$2", "call$1"], ["postMessage$2", "postMessage$1"], 79, 0, 0);
    ...
    _static_1(A, "sql_js_SqlJsModule_____tearOff$closure", "SqlJsModule_____tearOff", 78);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(String)", "~(String,@)", "~(JSObject)", "Frame()", "~(@)", "Frame(String)", "Null()", "~(Object,StackTrace)", "String(String)", "Future<Null>()", "~(Event)", "Object?(Object?)", "Future<~>()", "~(~())", "String(int)", "Trace(String)", "Null(@)", "bool(~)", "bool()", "~(Object?)", "~(@,@)", "@()", "int(int,int)", "int(int)", "~(Uint8List,String,int)", "~(String,String)", "Future<int>()", "int(Frame)", "String(Frame)", "Uint8List(@,@)", "@(@)", "~(Object[StackTrace?])", "Null(@,@)", "@(@,@)", "Null(@,StackTrace)", "Future<~>(Request)", "int?(int)", "Null(~)", "ResponsePayload?/(Request)", "Null(Object,StackTrace)", "Future<ResponsePayload?>()", "CancellationToken<@>?()", "Future<QueryResult>()", "~(Object?,Object?)", "~(int,@)", "int()", "Future<bool>()", "Map<String,@>(List<Object?>)", "~(MessageEvent)", "Null(JSObject)", "~([Object?])", "Null(~())", "0^(0^,0^)<num>", "List<Frame>(Trace)", "int(Trace)", "~(String,int)", "String(Trace)", "~(String,int?)", "@(@,String)", "Frame(String,String)", "Trace()", "_Future<@>(@)", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "~(String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "@(String)", "SqlJsModule(JSObject)", "~(@[List<Object>?])", "Null(bool)", "String(String?)"],
